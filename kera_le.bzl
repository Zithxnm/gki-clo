...
def define_kera_le():
    ...
    _kera_le_debug_in_tree_modules = _kera_le_in_tree_modules + [
        # keep sorted
    ...
    for variant in le_variants:
        ...
        if variant == "debug-defconfig":
            mod_list = _kera_le_debug_in_tree_modules
            board_kernel_cmdline_extras += [
                # do not sort
            ...
            mod_list = _kera_le_in_tree_modules
            board_kernel_cmdline_extras += ["nosoftlockup console=ttynull androidboot.serialconsole=0"]

        define_msm_le(
            msm_target = target_name,
            variant = variant,
            defconfig = "build.config.msm.kera.le",
